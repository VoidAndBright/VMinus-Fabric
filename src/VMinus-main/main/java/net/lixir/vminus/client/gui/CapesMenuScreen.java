...
public class CapesMenuScreen extends AbstractContainerScreen<CapesMenuMenu> {
    ...
    private static final Identifier texture = new Identifier("vminus:textures/screens/capes_menu.png");
    ...
    public void init() {
        super.init();
        imagebutton_beeper_cape = new ImageButton(this.leftPos + 18, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_beeper_cape.png"), 24, 48, e -> {
            if (NotHasBeeperCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(0, x, y, z));
        ...
        imagebutton_no_cape = new ImageButton(this.leftPos + 1, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_no_cape.png"), 24, 48, e -> {
            if (NotHasEmptyCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(1, x, y, z));
        ...
        imagebutton_no_cape_selected = new ImageButton(this.leftPos + 1, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_no_cape_selected.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
        ...
        imagebutton_beeper_cape_selected = new ImageButton(this.leftPos + 18, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_beeper_cape_selected.png"), 24, 48, e -> {
            if (HasBeeperCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(3, x, y, z));
        ...
        imagebutton_locked_cape = new ImageButton(this.leftPos + 18, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_locked_cape.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
                if (OwnsBeeperCapeProcedure.execute(entity))
        ...
        imagebutton_ghost_cape = new ImageButton(this.leftPos + 35, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_ghost_cape.png"), 24, 48, e -> {
            if (NotHasGhostCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(5, x, y, z));
        ...
        imagebutton_ghost_cape_selected = new ImageButton(this.leftPos + 35, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_ghost_cape_selected.png"), 24, 48, e -> {
            if (HasGhostCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(6, x, y, z));
        ...
        imagebutton_locked_cape1 = new ImageButton(this.leftPos + 35, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_locked_cape1.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
                if (OwnsGhostCapeProcedure.execute(entity))
        ...
        imagebutton_marrow_cape = new ImageButton(this.leftPos + 52, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_marrow_cape.png"), 24, 48, e -> {
            if (NotHasMarrowCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(8, x, y, z));
        ...
        imagebutton_marrow_cape_selected = new ImageButton(this.leftPos + 52, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_marrow_cape_selected.png"), 24, 48, e -> {
            if (HasMarrowCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(9, x, y, z));
        ...
        imagebutton_locked_cape2 = new ImageButton(this.leftPos + 52, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_locked_cape2.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
                if (OwnsMarrowCapeProcedure.execute(entity))
        ...
        imagebutton_shroud_cape = new ImageButton(this.leftPos + 69, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_shroud_cape.png"), 24, 48, e -> {
            if (NotHasShroudCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(11, x, y, z));
        ...
        imagebutton_shroud_cape_selected = new ImageButton(this.leftPos + 69, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_shroud_cape_selected.png"), 24, 48, e -> {
            if (HasShroudCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(12, x, y, z));
        ...
        imagebutton_locked_cape3 = new ImageButton(this.leftPos + 69, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_locked_cape3.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
                if (OwnsShroudCapeProcedure.execute(entity))
        ...
        imagebutton_troll_cape = new ImageButton(this.leftPos + 86, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_troll_cape.png"), 24, 48, e -> {
            if (NotHasTrollCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(14, x, y, z));
        ...
        imagebutton_troll_cape_selected = new ImageButton(this.leftPos + 86, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_troll_cape_selected.png"), 24, 48, e -> {
            if (HasTrollCapeProcedure.execute(entity)) {
                VMinus.PACKET_HANDLER.sendToServer(new CapesMenuButtonMessage(15, x, y, z));
        ...
        imagebutton_locked_cape4 = new ImageButton(this.leftPos + 86, this.topPos + 15, 24, 24, 0, 0, 24, new Identifier("vminus:textures/screens/atlas/imagebutton_locked_cape4.png"), 24, 48, e -> {
        }) {
            @Override
            public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
                if (OwnsTrollCapeProcedure.execute(entity))
