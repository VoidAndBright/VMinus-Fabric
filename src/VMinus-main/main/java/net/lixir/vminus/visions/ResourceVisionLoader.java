...
public class ResourceVisionLoader {
    ...
    public static JsonObject mergeModifiersFromResourcePacks(ServerLevel srvlvl_, String folderName) {
        ...
        class Output implements PackResources.ResourceOutput {
            ...
            @Override
            public void accept(Identifier Identifier, IoSupplier<InputStream> ioSupplier) {
                try {
                    ...
                    if (newJsonObject == null) {
                        VMinusMod.LOGGER.warn("Failed to parse JSON from resource: " + Identifier);
                        return;
                    }
                    ...
                    VMinusMod.LOGGER.error("Error processing resource: " + Identifier, e);
                }
            }
        }
