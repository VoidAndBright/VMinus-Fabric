...
public class CapeHelper {
    ...
    private static final List<UUID> CONTRIBUTORS = Arrays.asList(
            ...
            PONDEROSA);
    //Cape textures
    private static final Identifier BEEPER_CAPE = new Identifier("vminus", "textures/cape/beeper_cape.png");
    private static final Identifier GHOST_CAPE = new Identifier("vminus", "textures/cape/ghost_cape.png");
    private static final Identifier SHROUD_CAPE = new Identifier("vminus", "textures/cape/shroud_cape.png");
    private static final Identifier MARROW_CAPE = new Identifier("vminus", "textures/cape/marrow_cape.png");
    private static final Identifier PROTOTYPE_CAPE = new Identifier("vminus", "textures/cape/prototype_cape.png");
