...
public class VMinusLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(VMinusEntityAttributes.BLAST_PROTECTION, "Blast Protection");
        translationBuilder.add(VMinusEntityAttributes.BLUNT_PROTECTION, "Blunt Protection");
        translationBuilder.add(VMinusEntityAttributes.FALL_PROTECTION, "Fall Protection");
        translationBuilder.add(VMinusEntityAttributes.MAGIC_PROTECTION, "Magic Protection");
        translationBuilder.add(VMinusEntityAttributes.FIRE_PROTECTION, "Fire Protection");
        translationBuilder.add(VMinusEntityAttributes.MINING_SPEED, "Mining Speed");
        translationBuilder.add(VMinusEntityAttributes.CRITICAL_DAMAGE, "Critical Damage");
        translationBuilder.add(VMinusEntityAttributes.MOB_DETECTION_RANGE, "Critical Damage");
