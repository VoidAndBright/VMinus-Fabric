...
public class EnchantmentVisionString implements VisionValue<String, Enchantment> {
    private final String value;
    private final int priority;
    private final EnchantmentCondition[] conditions;
    public EnchantmentVisionString(String value, int priority, EnchantmentCondition[] conditions) {
        this.value = value;
