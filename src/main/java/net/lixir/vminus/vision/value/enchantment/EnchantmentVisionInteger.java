...
public class EnchantmentVisionInteger implements VisionValue<Integer, Enchantment> {
    private final Integer value;
    private final int priority;
    private final EnchantmentCondition[] conditions;
    public EnchantmentVisionInteger(Integer value, int priority, EnchantmentCondition[] conditions) {
        this.value = value;
