...
public class ItemVisionFoodProperties implements VisionValue<FoodProperties,Item> {
    private final FoodProperties value;
    private final int priority;
    private final ItemCondition[] conditions;
    public ItemVisionFoodProperties(FoodProperties value, int priority, ItemCondition[] conditions) {
        this.value = value;
        this.priority = priority;
        this.conditions = conditions;
    }
    public FoodProperties get_value() {
        return value;
    }
