...
public class VMinusItemTags {
    ...
    public static final TagKey<Item> CONCRETE_POWDER = registerTag("concrete_powder");
    ...
    public static final TagKey<Item> COSMETIC = registerTag("cosmetic");
    ...
    public static final TagKey<Item> SHEETS = registerTag("sheets");
    public static final TagKey<Item> SHULKER_BOXES = registerTag("shulker_boxes");
    public static final TagKey<Item> STACK_SIZE_64 = registerTag("stack_size_64");
    public static final TagKey<Item> STAINABLE_GLASS = registerTag("stainable_glass");
    ...
    public static final TagKey<Item> SWORDS_SHOVELS_AND_BOWS = registerTag("swords_shovels_and_bows");
    public static final TagKey<Item> SWORDS_SHOVELS_BOWS_AND_CROSSBOWS = registerTag("swords_shovels_bows_and_crossbows");
    public static final TagKey<Item> TOOLS_CROSSBOWS_AND_BOWS = registerTag("tools_bows_and_crossbows");
    public static final TagKey<Item> TOOLS_EXCEPT_SWORDS = registerTag("tools_except_swords");
